  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        gold: "hsl(var(--gold))", navy: "hsl(var(--navy))", "navy-light": "hsl(var(--navy-light))",
        sky: "hsl(var(--sky))", warm: "hsl(var(--warm))", lime: "hsl(var(--lime))",
        sidebar: {
      ...
      animation: {
        ...
        "fade-up": "fade-up 0.6s ease-out forwards", "fade-in": "fade-in 0.5s ease-out forwards",
      },
    },
  },
